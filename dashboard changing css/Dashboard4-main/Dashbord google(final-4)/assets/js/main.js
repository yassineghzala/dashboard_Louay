...
//var modal1 = document.getElementById("myModal_modify");


//var btn1 = document.getElementById("modify_Btn");


//var span1 = document.getElementsByClassName("close1")[0];
function btn1_1() {
  document.getElementById("myModal_modify").style.display = "block";
}
function close1_1() {
  document.getElementById("myModal_modify").style.display = "none";
}
window.onclick = function (event) {
  if (event.target == document.getElementById("myModal_modify")) {
    document.getElementById("myModal_modify").style.display = "none";
  }
}
...
//var btn2 = document.getElementById("delete_Btn");
...
window.onclick = function (event) {
  if (event.target == document.getElementById("myModal_delete")) {
    document.getElementById("myModal_delete").style.display = "none";
  }
}
...
//var modal3 = document.getElementById("myModal_modify2");


//var btn3 = document.getElementById("modify_Btn2");


//var span3 = document.getElementsByClassName("close3")[0];
function btn3_3() {
  document.getElementById("myModal_modify2").style.display = "block";
}
function close3_3() {
  document.getElementById("myModal_modify2").style.display = "none";
}
window.onclick = function (event) {
  if (event.target == document.getElementById("myModal_modify2")) {
    document.getElementById("myModal_modify2").style.display = "none";
  }
}

//var modal4 = document.getElementById("myModal_delete2");


//var btn4 = document.getElementById("delete_Btn2");


//var span4 = document.getElementsByClassName("close4")[0];
function btn4_4() {
  document.getElementById("myModal_delete2").style.display = "block";
}
function close4_4() {
  document.getElementById("myModal_delete2").style.display = "none";
}
window.onclick = function (event) {
  if (event.target == document.getElementById("myModal_delete2")) {
    document.getElementById("myModal_delete2").style.display = "none";
  }
}
...
//----------------------------------
//var modal5 = document.getElementById("myModal_modify5");


//var btn5 = document.getElementById("add_important_event");


//var span5 = document.getElementsByClassName("close5")[0];
function btn5_5() {
  document.getElementById("myModal_modify5").style.display = "block";
}
function close5_5() {
  document.getElementById("myModal_modify5").style.display = "none";
}
window.onclick = function (event) {
  if (event.target == document.getElementById("myModal_modify5")) {
    document.getElementById("myModal_modify5").style.display = "none";
  }
}


//var modal6 = document.getElementById("myModal_modify5");


//var btn6 = document.getElementById("add_normal_event");


//var span6 = document.getElementsByClassName("close6")[0];
function btn6_6() {
  document.getElementById("myModal_modify6").style.display = "block";
}
function close6_6() {
  document.getElementById("myModal_modify6").style.display = "none";
}
window.onclick = function (event) {
  if (event.target == document.getElementById("myModal_modify6")) {
    document.getElementById("myModal_modify6").style.display = "none";
  }
}
//#################################################################################################################################
...
function download() {
  ...
  for (let i = 0; i < downloadButtons.length; i++) {
    ...
    window.open("https://drive.google.com/file/d/1cti0MfxVWU5Y4Gxzu135qFUnLbe_JCN_/view?fbclid=IwAR3n2EZON4CmNoB_ZQpD7STTnQB9GGPONGLzolknSC02o39wi7UqWlc7Hh4" + (i + 1) + "_blank");
  };
}
